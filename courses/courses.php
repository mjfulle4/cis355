...
function printForm() {
	...
	echo "Day of Week<br/>";
	echo "<input type='text' placeholder='day' name='day'><br/>";
...
function printCourses($prefix, $courseNumber, $instructor, $day) {
    ...
    $term = "18/SP";
    $string = "https://api.svsu.edu/courses?prefix=$prefix&courseNumber=$courseNumber&term=$term&instructor=$instructor&meetingTimes=$day";
